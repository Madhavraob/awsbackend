...
/***/ "../../../../../src/app/_guards/adminauth.gaurd.ts":
...
var _a;
//# sourceMappingURL=adminauth.gaurd.js.map

/***/ }),

/***/ "../../../../../src/app/_guards/auth.gaurd.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_app_guards_auth_gaurd__ = __webpack_require__("../../../../../src/app/_guards/auth.gaurd.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_app_guards_adminauth_gaurd__ = __webpack_require__("../../../../../src/app/_guards/adminauth.gaurd.ts");
...
var appRoutes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3_app_home_home_component__["a" /* HomeComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_5_app_guards_adminauth_gaurd__["a" /* AdminAuthGuard */]] },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_2_app_login_login_component__["a" /* LoginComponent */] },
    { path: '**', redirectTo: '' }
];
var routing = __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* RouterModule */].forRoot(appRoutes);
...
AppRoutingModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_4_app_guards_auth_gaurd__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_5_app_guards_adminauth_gaurd__["a" /* AdminAuthGuard */]]
    })
], AppRoutingModule);
...
module.exports = "\n<nav class=\"navbar navbar-inverse\">\n  <div class=\"container-fluid\">\n    <div class=\"navbar-header\">\n      <a class=\"navbar-brand\" href=\"#\">Click For Quick Inst</a>\n    </div>\n    <ul class=\"nav navbar-nav\">\n      <li><a routerLink = \"/home\" routerLinkActive=\"active\">Home </a></li>\n      <li><a routerLinkActive=\"active\" (click)=\"cook()\">Users</a></li>\n      <!-- <li><a routerLink = \"/users\" routerLinkActive=\"active\" (click)=\"cook()\">Users</a></li> -->\n      <li style=\"float: right;clear: right;\"><a routerLink = \"/users\" routerLinkActive=\"active\">LogOut</a></li>\n    </ul>\n  </div>\n</nav>\n\n<div class=\"container\">\n<router-outlet></router-outlet>\n</div>\n\n<div class=\"col-md-6 col-md-offset-3\">\n    <h1>Hi {{currentUser}}!</h1>\n    <p>You're logged in with TallGrass!!</p>\n    <!--\n    <h3>All registered users:</h3>    \n    <ul>\n        <li *ngFor=\"let user of users\">\n            {{user.username}} ({{user.firstName}} {{user.lastName}})\n            - <a (click)=\"deleteUser(user.id)\">Delete</a>\n        </li>\n    </ul>      \n    <p><a [routerLink]=\"['/login']\">Logout</a></p>\n    -->\n</div>"
...
var HomeComponent = (function () {
    ...
    HomeComponent.prototype.cook = function () {
        this._loginService.cook().subscribe(function (resVideoData) {
...
// module
exports.push([module.i, ".imj{\r\n    \r\n    background-image: url(" + __webpack_require__("../../../../../src/assets/login.jpg") + "); \r\n    \r\n    height: 600px;\r\n    width: 1200px;\r\n    \r\n    /*\r\n    width: 100%;\r\n    height: auto;\r\n    */\r\n    /*background-size: 100% 100% ;\r\n    \r\n    /*background-size: cover;*/\r\n    \r\n    /*background-color: coral;*/\r\n}", ""]);
...
var LoginComponent = (function () {
    function LoginComponent(route, router, _loginService) {
        this.route = route;
        this.router = router;
        this._loginService = _loginService;
    }
    LoginComponent.prototype.ngOnInit = function () {
        this.userForm = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["c" /* FormGroup */]({
            username: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["d" /* FormControl */]("UserName", __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required),
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this._loginService.addVideo(this.userForm.value).subscribe(function (resVideoData) {
            console.log(resVideoData);
...
var LoginService = (function () {
    function LoginService(_http) {
        this._http = _http;
        this._getUrl = "/users/videos";
        /*private _postUrl = "http://localhost:3000/users/login";*/
        this._postUrl = "/users/login";
        this._putUrl = "/api/video/";
        this._deleteUrl = "/api/video/";
    }
    LoginService.prototype.cook = function () {
        console.log("ttt");
        console.log(__WEBPACK_IMPORTED_MODULE_2_ng2_cookies_ng2_cookies__["Cookie"].get('cookieName'));
        console.log(__WEBPACK_IMPORTED_MODULE_2_ng2_cookies_ng2_cookies__["Cookie"].get('currentUser'));
        return this._http.get("/users/coo").map(function (response) { return response.json(); });
    };
    LoginService.prototype.getVideos = function () {
        return this._http.get(this._getUrl).map(function (response) { return response.json(); });
    };
    LoginService.prototype.addVideo = function (user) {
        ...
        return this._http.post(this._postUrl, JSON.stringify(user), options)
            ...
            if (user && user.token) {
                ...
                __WEBPACK_IMPORTED_MODULE_2_ng2_cookies_ng2_cookies__["Cookie"].set('currentUser', JSON.stringify(user));
            }
            return user;
        });
    };
    LoginService.prototype.logout = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_2_ng2_cookies_ng2_cookies__["Cookie"].delete('currentUser');
    };
    return LoginService;
}());
...
module.exports = __webpack_require__.p + "login.2af8f263842dbc34fd61.jpg";
